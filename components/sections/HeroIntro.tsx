...
export function HeroIntro() {
  ...
  return (
    <section className="kb-hero-inverse relative isolate w-full overflow-hidden text-ink dark:text-text-inverse">
      <div className="kb-content-rail relative py-12 md:py-[5.99rem] lg:py-[6.84rem]">
        {/*
        ...
        */}
        <div className="relative z-[1] mb-8 md:pointer-events-none md:absolute md:inset-y-4 md:right-0 md:mb-0 md:flex md:w-[min(68%,720px)] md:items-center lg:w-[min(62%,760px)]">
          <div className="relative left-1/2 aspect-[1049/768] w-[106vw] max-w-none -translate-x-1/2 md:left-auto md:w-full md:translate-x-0">
        ...
        >
          ...
          <Typography
            variant="h1"
            as="h1"
            className="mb-5 mt-5 leading-[0.98] tracking-[-0.045em] text-ink dark:text-text-inverse lg:text-[clamp(3.25rem,5.5vw,4.5rem)] lg:leading-[0.98]"
          >
