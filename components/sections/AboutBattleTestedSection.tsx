...
export function AboutBattleTestedSection() {
  ...
  return (
    <>
      ...
      {documentPortalCaseStudy && (
        <CaseStudyModal
          caseStudy={documentPortalCaseStudy}
          isOpen={isModalOpen}
