...
export default function ResumeOneSheetPage() {
  ...
  const experience = [
    ...
    { period: "2021 — 2023", title: "Universal Windows Direct — Backend & Integration Engineer", logo: "/uwd-logo.png", bullets: ["Full-stack integration engineering role — automation infrastructure, API integrations, and internal tooling supporting marketing, sales, and operations across an enterprise home services organization.", "Built a custom API and automation layer connecting Five9 (call center), Mailchimp, CRM, and internal tools — replacing manual data handoffs across sales and marketing ops.", "Designed a shared logging and error handling framework used across all internal scripts — making the system debuggable and fast to extend.", "Migrated server infrastructure across 4 VPS partitions with zero downtime.", "Led full site migration from Joomla to WordPress, preserving all custom functionality."] },
        ...
        <div className="mb-5 print:mb-4 grid grid-cols-[1fr_auto] gap-4 items-center">
          <div className="flex items-center gap-4">
            <Image
              ...
              width={56}
              height={56}
              className="flex-shrink-0 h-14 w-14 print:h-12 print:w-12 object-contain"
            />
            <div>
          ...
          <div className="space-y-8 print:space-y-6">
            ...
            <section>
              ...
              <div className="space-y-2 text-sm print:text-xs">
                ...
                <p><strong>Platforms:</strong> WordPress VIP, WooCommerce, GTM, GA4, Mailchimp, Five9, Zapier, Databricks</p>
