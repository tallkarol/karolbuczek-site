...
export default function SolutionArchitectOneSheetPage() {
  ...
  const experience: ExperienceItem[] = [
      ...
      engagements: [
        {
          ...
          logo: "/gdi-logo.svg",
          bullets: [
            "Built modular integration architecture across 8 brands, connecting multiple CRMs and third-party vendors through shared cross-brand workflows.",
            "Contributing engineer on enterprise WordPress VIP migration: custom Gutenberg blocks, patterns, and templates for marketing self-serve.",
          ],
        },
        {
          ...
          bullets: [
            ...
            "Re-architected the B2B site as headless WordPress + React (mobile Lighthouse 51 → 94, TTI 12.5s → 3.1s).",
          ],
        },
        {
          client: "Bliss",
          ...
          logo: "/bliss-cb.png",
          bullets: [
            "Designed and shipped a serverless AWS document portal with managed identity, signed-URL delivery, RBAC, and immutable audit logging.",
          ],
        },
        {
          client: "Artist House",
          ...
          bullets: [
            "Production A&R platform: role-based analytics, automated chart/social crawls, XLSX reports, email delivery, and watchlists.",
            "Next.js/TypeScript with PostgreSQL, deployed on Vercel and Railway.",
          ],
        },
      ],
    },
    {
      ...
      bullets: [
        "Expanded and organized a centralized PHP script-based integration API connecting multiple systems including Five9, CRM, Mailchimp, and internal platforms. Implemented a shared logging and error-handling framework with modular route architecture.",
        ...
        <div className="mb-5 print:mb-4 grid grid-cols-[1fr_auto] gap-4 items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground print:text-xs">Full-Stack Engineer <span className="text-primary mx-1">·</span> Solutions Architect</p>
            </div>
          </div>
