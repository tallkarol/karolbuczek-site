...
export const allCaseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    summary: "Designed and implemented an integration architecture connecting diverse systems (Five9, Mailchimp, CRM, and others) — eliminating manual data handoffs and creating a single source of truth across sales and marketing operations.",
    ...
    solution: "Designed a templatable, maintainable service-oriented integration layer to replace fragmented, brittle connections between diverse systems (Five9, Mailchimp, CRM, and others). Implemented a modular route architecture and a standardized logging framework to ensure the entire system was observable and extensible for future platform onboarding.",
  ...
  },
  {
    ...
    title: "Mineralife B2B Website Rebuild",
    subtitle: "Headless WordPress + React for Service Repositioning",
    summary: "Full rebuild of Mineralife's B2B web presence to align with a new service focus and brand repositioning — headless WordPress for content management, React for the delivery layer, rebuilt lead forms with qualifying and scheduling, and a pipeline into a custom CRM built to sales-team specifications.",
    problem: "The legacy B2B site no longer reflected Mineralife's repositioned service offering. Performance was poor on mobile, lead capture was generic, and inquiries weren't qualifying prospects or feeding sales workflows effectively.",
    constraints: [
      "CMS Continuity: Marketing needed WordPress for content management — chose headless architecture to preserve the editing workflow while replacing the slow, monolithic frontend.",
      "Lead Quality: Generic contact forms weren't enough — rebuilt forms for targeted capture with built-in qualifying logic and scheduling before handoff to sales.",
      "Sales Workflow Fit: Qualified leads needed to flow into a custom CRM being built to the exact specifications of Mineralife sales staff, not a generic off-the-shelf tool.",
    ],
    solution: "Rebuilt the B2B site as a headless WordPress + React application on Vercel, keeping WordPress as the CMS while replacing the legacy frontend with a leaner React delivery layer. Redesigned lead forms end to end for targeted capture, qualification, and scheduling, with integration into a custom sales CRM tailored to how the team actually works.",
    tags: ["Full-Stack Development", "WordPress Engineering", "Performance Engineering", "Product & Internal Tools"],
    ...
    image: "/mineralife-logo.png",
    imageFit: "contain",
    clientLogo: "/mineralife-logo.png",
    clientDescription: "B2B nutraceutical manufacturer repositioning service offerings and rebuilding digital lead capture for qualified inquiry management.",
    clientStage: "Growth stage",
    previewBusOutcome: "Mobile Lighthouse 67 → 94, TTI 14.6s → 3.1s, network requests 109 → 51.",
  },
  {
